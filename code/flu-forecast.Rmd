...
In order to improve the clarity of the plots above, we remove the four states
with extreme hospitalization rates (don't know how to adjust the y limits
in a `facet_wrap`, and I don't think this substantially changes the conclusions
of the EDA.
...
October 31, 2021.  For each forecast date, we predict 5 days ahead to 
