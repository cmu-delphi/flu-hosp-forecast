...
# Add geos you want excluded from state AND national-level forecasts here.
exclude_geos = c("")
preds_state_processed = preds_state_processed %>% filter (
...
# VI removed as data has just been zeroes and forecaster time window leads to
# following trends from other locations and doesn't cover 0.
# Add geos you want excluded from state, but not national-level forecasts here.
exclude_geos = c("vi")
